...
<body>
<div class="container">
		<label id="formHeading">Category Wise Sales Order Report</label>
		<s:form name="frmCategoryWiseSalesOrderReport" method="POST" action="rptCategoryWiseSalesOrderReport.html" target="_blank">
	   		<div class="row">
	   			<div class="col-md-3">
					<div class="row">
				...
				<div class="col-md-6"><label>From Fulfillment Date</label>
						<s:input type="text" id="dteFromFulfillment" path="dteFromFulfillment" style="width: 70%" required="true" class="calenderTextBox" onchange="update_FromFulFillmentDate(this.value);"/>
				</div>
				<div class="col-md-6"><label>To Fulfillment Date</label>
						<s:input type="text" id="dteToFulfillment" path="dteToFulfillment" style="width: 70%" required="true" class="calenderTextBox" />
				</div>
				</div></div>
			 ...
			 <table class="transTable">
				<tr>
					<td width="49%">Group
						<input type="text" style="width: 35%"  id="searchGrp" Class="searchTextBox">
					</td>
					<td width="49%">Sub Group
						  <input type="text" id="searchSGrp" style="width: 35%" Class="searchTextBox" >
				</td>
			</tr>
			   ...
			   <div class="row">
					...
					<s:select id="cmbReportType" path="strReportType" style="width:75%">
