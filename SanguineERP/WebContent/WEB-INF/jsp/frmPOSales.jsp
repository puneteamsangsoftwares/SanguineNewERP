...
// 		alert(locCode+ "        "+dtFullFilled);
	...
	function funFillDetails(locCode,dtFullFilled,orderType)
	{
		
		var searchUrl=getContextPath()+"/loadSOforProductionOrder.html?strlocCode="+locCode+"&dtFullFilled="+dtFullFilled+"&orderType="+orderType;	
		$.ajax({
	 	        type: "GET",
	 	        url: searchUrl,
	 		    dataType: "json",
	...
	{	   
	    ...
	    row.insertCell(5).innerHTML= "<input readonly=\"readonly\" class=\"Box\" size=\"12%\" id=\"strOrderType."+(rowCount)+"\" value='"+orderType+"' >";
...
<div style="width: 100%; height: 40px; background-color: #458CCA">
		<p align="center" style="padding-top: 5px;color: white">SO for Production Order</p>
	</div>
    <s:form id="form1">       
...
<!--                         </div> -->
			...
			<div
				style="background-color: #C0E2FE; border: 1px solid #ccc; display: block; height: 250px; margin: auto;  width: 99.80%; overflow-y: scroll;">
					<table id="tblDNDet"
