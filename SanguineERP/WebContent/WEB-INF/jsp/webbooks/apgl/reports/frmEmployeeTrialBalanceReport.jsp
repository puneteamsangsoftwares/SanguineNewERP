...
<title>Employee trail Balance Report</title>
...
<body>
	<div class=" container transTable">
		<label id="formHeading">Employee Trial Balance Report</label>
	<s:form name="frmEmployeeTrailBalanceReport" method="GET" action="rptEmployeeTrialBalanceReport.html" target="_blank">
		<div class="row">
			       <div class= "col-md-2"><label>GL Code</label>
			  		...
			  		<div class= "col-md-3"><label id="lblGLCode" style="background-color:#dcdada94; width: 100%; height: 42%; margin: 27px 0px;"></label></div>
			  		...
			  		<div class= "col-md-3">
			  		     <div class="row">
					          <div class= "col-md-6"><label>From Date </label>
			                       <s:input id="txtFromDate" path="dteFromDate" required="true" style="height:45%" readonly="readonly" cssClass="calenderTextBox"/>
			                  </div>
			                  <div class= "col-md-6"><label>To Date </label>
					               <s:input id="txtToDate" path="dteToDate" required="true" style="height:45%" readonly="readonly" cssClass="calenderTextBox"/>
					          </div>
					</div></div>          	
