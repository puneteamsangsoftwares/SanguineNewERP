		...
		$
				.ajax({
					...
					success : function(response) 
					{
						...
						document.APGLsecurityShell.action = "APGLSecurity.html?userCode="+ code;
						document.APGLsecurityShell.submit();
					},
		...
		$
				.ajax({
					...
					success : function(response) 
					{
						...
						document.APGLsecurityShell.action = "LikeAPGLsersecurity.html?userCode="+ code;
						document.APGLsecurityShell.submit();
					},
					error: function(jqXHR, exception) {
			            if (jqXHR.status === 0) {
