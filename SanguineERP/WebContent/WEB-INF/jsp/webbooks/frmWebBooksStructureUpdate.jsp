...
<script type="text/javascript">
		...
		function getContextPath() 
		  ...
		  */
		  function funUpdateStructure(){
				 $.ajax({
				  type: "GET",
				  url: getContextPath()+"/updateWebBooksStructure.html",
				  dataType:"text",
				  async:false,
		...
		function funClearTransaction()
		{
			...
			if(isOk)
			{
			var searchurl=getContextPath()+"/ClearWebBooksTransaction.html?frmName="+member+"&propName="+propName+"&locName="+locName ;
			 $.ajax({
				  type: "GET",
				  url: searchurl,
				  dataType:"text",
		...
		function funClearMaster(){
			...
			if(isOk)
			{
			 $.ajax({
			  type: "GET",
			  url: getContextPath()+"/ClearWebBooksMaster.html?frmName="+member,
			  dataType:"text",
			  async:false,
			  success: function(response){
				  alert(response);
		...
		//	var returnVal=window.showModalDialog("frmDeleteModuleList.html?strHeadingType="+strType,"","dialogHeight:600px;dialogWidth:500px;dialogLeft:350px;dialogTop:100px");
			var returnVal=window.open("frmWebBooksDeleteModuleList.html?strHeadingType="+strType,"","dialogHeight:600px;dialogWidth:500px;dialogLeft:350px;dialogTop:100px");
