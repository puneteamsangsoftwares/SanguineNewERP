...
<div class="container transTable">
		<label id="formHeading">Slow Moving Items Report</label>
	 ...
	 <div class="row">
			 <div class="col-md-2"><label id="lblFromDate">From Date</label>
			  ...
			  <div class="col-md-6">
			    ...
			    <div class="col-md-2"><label>Percentage</label>
				      <s:input type="text" required="true" id="txtPercentage" path="dblPercentage" cssStyle="width:45%" class="decimal-places numberField"></s:input>
				</div>		
			...
			<p align="center">
				 <input type="submit" value="Submit" class="btn btn-primary center-block" class="form_button" onclick="return Submit_onClick()"/>
				 &nbsp;
