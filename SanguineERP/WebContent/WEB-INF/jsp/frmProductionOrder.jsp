...
<!-- 		<label>Meal Planning</label> -->
	...
	<s:form method="POST" action="saveProductionOrderData.html?saddr=${urlHits}" name="productonorderform">
		 ...
		 <div class="row">
		     ...
		     <div class="col-md-2"><label>Production Order Code</label>
				   <s:input path="strOPCode" id="strOPCode" ondblclick="funHelp('ProductionOrder')" cssClass="searchTextBox" />
			 </div>
			 
			 <div class="col-md-2"><label>Date</label>
				  <s:input path="dtOPDate" id="dtOPDate" required="true" autocomplete="false" cssClass="calenderTextBox" style="width:70%"/>
			 </div>
			 
			<div class="col-md-2"><label>Status </label>
				<s:label path="strStatus" style="background-color:#dcdada94; width: 100%; height:51%;padding:4px;"></s:label>
			</div>
            <div class="col-md-6"></div>
            
			<div class="col-md-2"><label>Against</label>
				<s:select id="cmbAgainst" items="${strProcessList}" onchange="funOnChange();" name="cmbAgainst" path="strAgainst" style="width:auto">
				</s:select>
			</div>
			
			<div class="col-md-2"><br>
			   <s:input id="txtDocCode" path="strDocCode" readonly="readonly" ondblclick="funOpenAgainst()" class="searchTextBox" style="margin-top: 11px;"></s:input>
			</div>		
...
<%-- 					</s:select></td> --%>
			  ...
			  <div class="col-md-2"><label>Fullfillment Date</label>
				   <s:input path="dtFulmtDate" id="dtFulmtDate" required="true" cssClass="calenderTextBox" style="width:70%" />
		      </div>
			
			  <div class="col-md-2"><label>Fullfilled Date</label>
				   <s:input path="dtfulfilled" id="dtfulfilled" required="true" cssClass="calenderTextBox" style="width:70%"/>
			   </div>
                <div class="col-md-8"></div>
			  ...
			  <div class="col-md-2">
			   <label id="strLocName" class="namelabel" style="background-color:#dcdada94; width: 100%; height:51%;margin-top: 27px;padding:4px;">${locationName}</label>
			    </div>
              <div class="col-md-8"></div>
              
		    <div class="col-md-2"><label>Product</label>
				<input id="strProdCode" ondblclick="funHelp('productProduced')" class="searchTextBox" />
			</div>
			
			<div class="col-md-2"><label id="strProductName" class="namelabel" style="font-size: 12px;background-color:#dcdada94; width: 100%; height:51%;margin-top: 25px;padding:4px;"></label>
		    </div>
		   
			<div class="col-md-2"><label id="Stock" class="namelabel">Stock</label>
		         <label id="lblStock" class="namelabel" style="background-color:#dcdada94; width: 100%; height:51%;padding:4px;"></label>
			</div>
            <div class="col-md-6"></div>
			...
			<div class="col-md-2"><br><input type="button" value="Add"
					onclick="return btnAdd_onclick()" class="btn btn-primary center-block" class="smallButton" id="btnAdd"/>
			</div>
	<br>
