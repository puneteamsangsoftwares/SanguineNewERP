...
<script type="text/javascript">
	...
	function funValidateFields()
	{
		var flag=false;
			...
			window.open(getContextPath()+"/rptRevenueHeadReport.html?fromDate="+fy+"-"+fm+"-"+fd+"&toDate="+ty+"-"+tm+"-"+td);
...
<body>
 <div class="container masterTable"> 
	<label id="formHeading">Revenue Head Report</label>
	<s:form name="RevenueHeadReport" method="GET" action="">
			<div class="row">
