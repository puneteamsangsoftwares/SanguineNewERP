...
<script>
	...
	function funValidateFields()
	{
		var flag=false;
			...
			window.open(getContextPath()+"/rptCheckOutList.html?fromDate="+fy+"-"+fm+"-"+fd+"&toDate="+ty+"-"+tm+"-"+td+" ");
...
<body onload="funOnLoad();">
	<div class="container masterTable">
		<label id="formHeading">Check-Out List </label>
	<s:form name="frmCheckOutList" method="GET" action="" >
	<div class="row">
		<div class="col-md-3">
			<div class="row">
