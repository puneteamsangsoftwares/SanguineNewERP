...
<script>
    function funValidateFields()
	{
		var flag=false;
			...
			window.open(getContextPath()+"/rptCancelationReport.html?fromDate="+fy+"-"+fm+"-"+fd+"&toDate="+ty+"-"+tm+"-"+td+" ");
...
<body onload="funOnLoad();">
	...
	<label id="formHeading">Reservation Cancellation Report </label>
	    <s:form name="frmCancelationReport" method="GET" action="" >
		<div class="row">
            <div class="col-md-3">
			    <div class="row">
