	   ...
	   function formSubmit()
	    {
		    ...
		    else
		    {
		    	...
		    	document.forms["frmConsReceiptValMiscSuppReqReport"].submit();
		    }
	    } 
	...
	<div class="container transTable">
	    ...
	    <s:form name="frmConsReceiptValMiscSuppReqReport" method="POST" action="rptConsReceiptValMiscSuppReqReport.html" target="_blank">
		   ...
		   <div class="col-md-2"><label>Location</label>
				<input type="text" id="txtToLocCode" readonly="true" ondblclick="funHelp('locationmaster')" Class="searchTextBox" placeholder="Type to search" style="width:100%;"></input>
