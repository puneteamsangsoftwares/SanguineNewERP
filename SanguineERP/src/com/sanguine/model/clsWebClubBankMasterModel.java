...
@IdClass(clsWebClubBankMasterModel_ID.class)
public class clsWebClubBankMasterModel implements Serializable {
	private static final long serialVersionUID = 1L;

	public clsWebClubBankMasterModel() {
	}

	public clsWebClubBankMasterModel(clsWebClubBankMasterModel_ID objModelID) {
