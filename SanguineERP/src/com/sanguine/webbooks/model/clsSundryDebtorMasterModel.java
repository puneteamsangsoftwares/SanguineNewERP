...
@IdClass(clsSundryDebtorMasterModel_ID.class)
public class clsSundryDebtorMasterModel implements Serializable {
	private static final long serialVersionUID = 1L;

	public clsSundryDebtorMasterModel() {
	}

	public clsSundryDebtorMasterModel(clsSundryDebtorMasterModel_ID objModelID) {
		strDebtorCode = objModelID.getStrDebtorCode();
	...
	@Column(name = "strDebtorStatusCode")
	...
	public void setStrDebtorFullName(String strDebtorFullName) {
		this.strDebtorFullName = (String) setDefaultValue(strDebtorFullName, "");
	}
	...
	public void setStrDebtorStatusCode(String strDebtorStatusCode) {
		this.strDebtorStatusCode = (String) setDefaultValue(strDebtorStatusCode, "");
	}
