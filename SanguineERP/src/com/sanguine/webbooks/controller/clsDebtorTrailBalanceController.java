...
@Controller
public class clsDebtorTrailBalanceController {
	...
	@RequestMapping(value = "/frmDebtorTrialBalanceReport", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/rptDebtorTrialBalanceReport", method = RequestMethod.GET)
