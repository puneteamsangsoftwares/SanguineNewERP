...
@Controller
public class clsChequeIssuedReport 
{
	@Autowired
	...
	@RequestMapping(value = "/frmChequeIssued", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/rptChequeIssuedReport", method = RequestMethod.GET)
	private void funReport(@ModelAttribute("command") clsChequeReportBean objBean, HttpServletResponse resp, HttpServletRequest req) {
		try {
			...
			sbSql.append("select a.strVouchNo, a.strBankCode as paymentBankCode, b.strAccountName, a.strChequeNo, a.dblAmt, a.dteVouchDate, a.dteChequeDate, c.strBankName,c.strBankCode    "
					+ " from tblpaymenthd a, tblacmaster b, tblbankmaster c "
					+ " where a.strBankCode = b.strAccountCode "
			...
			{
				sbSql.append(" and a.strBankCode='"+hmBank.get(objBean.getStrBankName())+"' ");
			}
			...
			hm.put("stReportName", "Cheque Issued Report");
			hm.put("stBankOrCFCCode", "Bank Code");
