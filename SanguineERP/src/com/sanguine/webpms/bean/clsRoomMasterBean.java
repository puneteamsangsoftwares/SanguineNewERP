...
public class clsRoomMasterBean {
	...
	private String strColourScheme;
	...
	public void setStrFurniture(String strFurniture) {
		this.strFurniture = strFurniture;
	}
	...
	public void setStrUpholstery(String strUpholstery) {
		this.strUpholstery = strUpholstery;
	}
	...
	public String getStrColourScheme() {
		return strColourScheme;
	}

	public void setStrColourScheme(String strColourScheme) {
		this.strColourScheme = strColourScheme;
	}
	...
	public void setStrPolishType(String strPolishType) {
		this.strPolishType = strPolishType;
	}
	...
	public void setStrGuestAmenities(String strGuestAmenities) {
		this.strGuestAmenities = strGuestAmenities;
	}
	...
	public void setStrInterConnectRooms(String strInterConnectRooms) {
		this.strInterConnectRooms = strInterConnectRooms;
	}
	...
	public void setStrProvisionForSmokingYN(String strProvisionForSmokingYN) {
		this.strProvisionForSmokingYN = strProvisionForSmokingYN;
	}
	...
	public void setStrDeactiveYN(String strDeactiveYN) {
		this.strDeactiveYN = strDeactiveYN;
	}
