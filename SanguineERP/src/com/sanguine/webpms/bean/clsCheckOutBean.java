...
public class clsCheckOutBean {
	...
	private List<clsCheckOutRoomDtlBean> listCheckOutRevenueDtlBeans = new ArrayList<clsCheckOutRoomDtlBean>();
	...
	public List<clsCheckOutRoomDtlBean> getListCheckOutRevenueDtlBeans() {
		return listCheckOutRevenueDtlBeans;
	}

	public void setListCheckOutRevenueDtlBeans(
			List<clsCheckOutRoomDtlBean> listCheckOutRevenueDtlBeans) {
		this.listCheckOutRevenueDtlBeans = listCheckOutRevenueDtlBeans;
	}
