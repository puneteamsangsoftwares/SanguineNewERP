...
public class clsGuestMasterBean {
	...
	private String  strStatePermanent, strCountryPermanent;

	private int intPinCodePermanent;
	
	private String strAddressOfc,  strCityOfc, strStateOfc ,strCountryOfc;
	...
	public void setStrDefaultAddr(String strDefaultAddr) {
		this.strDefaultAddr = strDefaultAddr;
	}
	...
	public void setStrAddressLocal(String strAddressLocal) {
		this.strAddressLocal = strAddressLocal;
	}
	...
	public void setStrCityLocal(String strCityLocal) {
		this.strCityLocal = strCityLocal;
	}
	...
	public void setStrStateLocal(String strStateLocal) {
		this.strStateLocal = strStateLocal;
	}
	...
	public void setStrCountryLocal(String strCountryLocal) {
		this.strCountryLocal = strCountryLocal;
	}
	...
	public void setStrAddrPermanent(String strAddrPermanent) {
		this.strAddrPermanent = strAddrPermanent;
	}
	...
	public void setStrCityPermanent(String strCityPermanent) {
		this.strCityPermanent = strCityPermanent;
	}
	...
	public void setStrStatePermanent(String strStatePermanent) {
		this.strStatePermanent = strStatePermanent;
	}
	...
	public void setStrCountryPermanent(String strCountryPermanent) {
		this.strCountryPermanent = strCountryPermanent;
	}
	...
	public void setStrAddressOfc(String strAddressOfc) {
		this.strAddressOfc = strAddressOfc;
	}
	...
	public void setStrCountryOfc(String strCountryOfc) {
		this.strCountryOfc = strCountryOfc;
	}
	...
	public double getDblClosingBalance() {
		return dblClosingBalance;
	}

	public void setDblClosingBalance(double dblClosingBalance) {
		this.dblClosingBalance = dblClosingBalance;
	}
