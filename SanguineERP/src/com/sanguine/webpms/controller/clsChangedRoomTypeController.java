			...
			*/
			...
			// get bill details
				...
				String sqlBillDtl = "SELECT a.strRoomNo,a.strRemark,c.strReasonDesc,e.strRoomDesc as newRoomNo,"
						+ "CONCAT(d.strFirstName,' ',d.strMiddleName,' ',d.strLastName),a.strUserEdited ,e.strBedType,a.strRoomTypeCode ,f.strRoomTypeDesc "
						+ "FROM tblchangeroom a,tblcheckindtl b,tblreasonmaster c,tblguestmaster d,tblroom e,tblroomtypemaster f "
						+ "WHERE a.strGuestCode=b.strGuestCode AND a.strReason=c.strReasonCode AND a.strGuestCode=d.strGuestCode "
						+ "and b.strRoomNo=e.strRoomCode and e.strRoomTypeCode=f.strRoomTypeCode AND b.strClientCode='"+clientCode+"' AND c.strClientCode='"+clientCode+"' AND d.strClientCode='"+clientCode+"' AND e.strClientCode='"+clientCode+"'"
				...
				for (int i = 0; i < roomDtlList.size(); i++) 
				{
					...
					roomBean.setStrNewRoomTypeDesc(roomArr[8].toString());
