...
@Controller
public class clsPMSSecurityShellController {
	...
	@RequestMapping(value = "/frmPMSSecurityShell", method = RequestMethod.GET)
	public ModelAndView funOpenSecurityShellForm(@ModelAttribute("command") @Valid clsSecurityShellBean objBean, BindingResult result, Map<String, Object> model, HttpServletRequest request) {
		...
		if ("2".equalsIgnoreCase(urlHits)) {
			return new ModelAndView("frmPMSSecurityShell_1");
		} else if ("1".equalsIgnoreCase(urlHits)) {
			return new ModelAndView("frmPMSSecurityShell");
		} else {
			return new ModelAndView("frmPMSSecurityShell");
		}
	...
	@RequestMapping(value = "/pmsSecurity", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/LikePMSUsersecurity", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/savePMSSecurityShell", method = RequestMethod.POST)
	public ModelAndView funAddUpdate(@ModelAttribute("command") @Valid clsSecurityShellBean objBean, BindingResult result, HttpServletRequest req) {
		...
		return new ModelAndView("redirect:/frmPMSSecurityShell.html?saddr=" + urlHits);
