...
public class clsSubContractorMasterModel {
	...
	private String strIBANNo, strSwiftCode, strCategory, strExcisable, strClientCode, dtInstallions, strAccManager;
	...
	public clsSubContractorMasterModel() {
	}

	public clsSubContractorMasterModel(clsPartyMasterModel_ID clsPartyMasterModel_ID) {
