...
@IdClass(clsPartyMasterModel_ID.class)
public class clsPartyMasterModel extends clsBaseModel {
	...
	private double dblCreditLimit, dblLatePercentage, dblRejectionPercentage, dblDiscount;
	private String strIBANNo, strSwiftCode, strCategory, strExcisable, strClientCode, strPartyIndi, strDebtorCode;
	private String strOperational, strECCNo, dtInstallions, strAccManager;
	private String strGSTNo, strPNHindi, strLocCode, strLocName, strPropCode, strCurrency, strApplForWT;
	...
	public clsPartyMasterModel() {
	}

	public clsPartyMasterModel(clsPartyMasterModel_ID clsPartyMasterModel_ID) {
		strPCode = clsPartyMasterModel_ID.getStrPCode();
	...
	@Column(name = "strPNHindi")
	public String getStrPNHindi() {
		return strPNHindi;
	}

	public void setStrPNHindi(String strPNHindi) {
		this.strPNHindi = strPNHindi;
	}
	
	@Column(name = "strApplForWT")
	public String getStrApplForWT() {
		return strApplForWT;
	}

	public void setStrApplForWT(String strApplForWT) {
		this.strApplForWT = (String) setDefaultValue(strApplForWT, "N");
	}
