...
@Controller
public class clsCRMSecurityShellController {
	...
	@RequestMapping(value = "/frmCRMSecurityShell", method = RequestMethod.GET)
	public ModelAndView funOpenSecurityShellForm(@ModelAttribute("command") @Valid clsSecurityShellBean objBean, BindingResult result, Map<String, Object> model, HttpServletRequest request) {
		...
		if ("2".equalsIgnoreCase(urlHits)) {
			return new ModelAndView("frmCRMSecurityShell_1");
		} else if ("1".equalsIgnoreCase(urlHits)) {
			return new ModelAndView("frmCRMSecurityShell");
		} else {
			return new ModelAndView("frmCRMSecurityShell");
		}
	...
	@RequestMapping(value = "/saveCRMSecurityShell", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/crmSecurity", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/LikeCRMUsersecurity", method = RequestMethod.POST)
