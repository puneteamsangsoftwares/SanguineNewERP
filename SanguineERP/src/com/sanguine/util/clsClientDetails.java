...
public class clsClientDetails {
	...
	public static void funAddClientCodeAndName() {
		try {
			...
			hmClientDtl.put("117.001", clsClientDetails.createClientDetails("117.001", "THE PREM'S HOTEL", dFormat.parse("2016-08-01"), dFormat.parse("2022-09-01")));//renewed from 1-9-2020 to 1-9-2021 as Sachin sir said//renewed on 01-07-2020 for 15 days till 15-07-2020// HO
			...
			hmClientDtl.put("136.001", clsClientDetails.createClientDetails("136.001", "KINKI", dFormat.parse("2017-01-05"), dFormat.parse("2022-01-20")));// released on
			...
			hmClientDtl.put("178.001", clsClientDetails.createClientDetails("178.001", "UNWIND", dFormat.parse("2017-07-27"), dFormat.parse("2020-07-03")));//renewed on 23-06-2020 till 03-07-2020//renewd for 1 year on 27-06-2019 till 2020-06-25
			...
			hmClientDtl.put("194.001", clsClientDetails.createClientDetails("194.001", "SWIG", dFormat.parse("2017-09-11"), dFormat.parse("2022-10-30"))); // Name
			...
			hmClientDtl.put("211.001", clsClientDetails.createClientDetails("211.001", "CHEFS CORNER", dFormat.parse("2017-11-29"), dFormat.parse("2021-08-31")));//renewed on 25-06-2019 for 10 days till 09-07-2019//Renewed On 17-05-2019 for 15 days till 31-05-2019// Renewed on 16-04-2019 for 1 month till 16-05-2019//Renewed on 14-03-2019 for 1 month till 16-04-2019//renewed on 15-02-2019 for 1 month till 15-03-2019 //renwed for on emonth on 01-12-2018 till  //renewed  on 30-11-2018 for one month till 30-12-2018  // renewd
			...
			hmClientDtl.put("225.001", clsClientDetails.createClientDetails("225.001", "SHEESHA SKY LOUNGE HOSPITALITY AND SERVICES PVT LTD", dFormat.parse("2018-08-21"), dFormat.parse("2021-12-31")));//From POS 
			...
			hmClientDtl.put("240.001", clsClientDetails.createClientDetails("240.001", "THOUSAND OAKS", dFormat.parse("2018-04-12"), dFormat.parse("2021-08-12")));//renewed on 06-11-2020 for 10 days till 17-11-2020//renewed on 22-05-2019 for 1 year//renewed on 01-12-2018 for one month till 01-01-2019//renewed on 20-08-2018 for 1 week till 27-08-2018 //renewed on 13-06-2018 for 1 month// Mr. Sanjeet Lamba", 2417 East Street (G T Road),Camp, Pune 411001. Tel: (020) 2634 3194 / 2634 5598
		   ...
		   //260.001", "PARAG HOTELS AND RESORT PVT LTD" for POS
			hmClientDtl.put("260.001", clsClientDetails.createClientDetails("260.001", "PARAG HOTELS AND RESORT PVT LTD", dFormat.parse("2019-12-16"), dFormat.parse("2020-12-16")));//(Mumbai)//released on 16-12-2019 for 1 month  till 16-01-2020 
			...
			hmClientDtl.put("267.001", clsClientDetails.createClientDetails("267.001", "THE MASTER CLOCK & WATCH WORKS PVT LTD", dFormat.parse("2018-10-04"), dFormat.parse("2021-12-14")));//Renewed on 12-03-2019 for 1 year till 25-12-2019 //renewed on 06-12-2018 for one month till 06-01-2019// One month stsrt date 2018-10-04  end date Office	AddressB-304,	Dynasty	Business	Park,J.B.Nagar,Andheri	Kurla	Road,	Andheri	East	Mumbai-400059. Contact	Person(s)-Mr.Sandesh,Contact	Number(s)9987994188  Email	ID Sandesh.aga@gmail.com //MUBASHIR//Renew  on 04-05-2018			
			hmClientDtl.put("268.001", clsClientDetails.createClientDetails("268.001", "ROVE HOSPITALITY", dFormat.parse("2018-10-04"), dFormat.parse("2020-10-15")));//Renewed on 16-10-2019 for one year till 2020-10-15//(Pune)//renewed on 23-11-2018 for 1 year till 15-10-2019 "Amol Gargote", "9545160160", "amololive6@gmail.com", 			
			...
			hmClientDtl.put("273.001", clsClientDetails.createClientDetails("273.001", "SHEESHA SKY LOUNGE", dFormat.parse("2018-10-25"), dFormat.parse("2021-10-24")));//released on 25-10-2018 for 1 Year till 24-10-2019 for 1 SPOS ,0 APOS,0 WebStocks,No SMS Pack,No Bill Deletion.", "Mr.Alam", "9920939306", "alam.sky@gmail.com");			
			...
			hmClientDtl.put("289.001", clsClientDetails.createClientDetails("289.001", "RIVERSIDE BISTRO & BANQUET", dFormat.parse("2020-02-10"), dFormat.parse("2022-03-31")));////Released for 1 month till 03-10-2020
			...
			hmClientDtl.put("319.001", clsClientDetails.createClientDetails("319.001", "LAXMI FOODS", dFormat.parse("2019-06-04"), dFormat.parse("2022-06-04")));//Renewed on 6-7-2021 for 1 year till 4-6-2022//Renewed on 15-01-2021 for 1 year till 19-01-2022 // Released on 07-08-2019 for 1 year till 03-06-2020
			hmClientDtl.put("320.001", clsClientDetails.createClientDetails("320.001", "HOTEL SURYA", dFormat.parse("2019-06-13"), dFormat.parse("2021-09-30")));//Renewed on 02-04-2021 for 6 month till 30-09-2021//Renewed on 08-11-2020 for 6 month till 31-03-2021//Renewed on 30-07-2020 for 1 week//Renewed on 08-11-2019 for one month till 2019-12-15//Renewed on 15-10-2019 for one month till 2019-11-15  //Renewed on 05-10-2019 till 17-10-19//Released on 24-07-2019 for 1 month till 23-08-2019//Released on 16-06-2019 for 1 week till 23-07-2019// Released on 13-06-2019 for 1 month till 15-07-2019
			...
			hmClientDtl.put("341.001", clsClientDetails.createClientDetails("341.001", "THE FLOUR WORKS", dFormat.parse("2019-12-01"), dFormat.parse("2021-08-09")));//(Mumbai)//Renewed for 1 month on 6-7-2021//Released on 09-12-2019 for 1 year till 09-12-2020
			...
			hmClientDtl.put("346.001", clsClientDetails.createClientDetails("346.001", "MNV HOSPITALITY LLP", dFormat.parse("2020-02-01"), dFormat.parse("2021-12-10")));//(Mumbai)//Released on 04-02-2020 for 1 month till 10-03-2020
			...
			hmClientDtl.put("365.001", clsClientDetails.createClientDetails("365.001", "TMF HOSPITALITY LLP", dFormat.parse("2020-07-27"), dFormat.parse("2021-08-12")));//(Mumbai)//Released on 27-07-2020 for 3 month till 27-10-2020
			...
			hmClientDtl.put("378.001", clsClientDetails.createClientDetails("378.001", "CERATEC", dFormat.parse("2020-12-14"), dFormat.parse("2021-07-25")));
			...
			hmClientDtl.put("383.001", clsClientDetails.createClientDetails("383.001", "ARON HOTEL AND RESORTS PVT. LTD", dFormat.parse("2021-01-08"), dFormat.parse("2021-07-10")));			
			...
			hmClientDtl.put("391.001", clsClientDetails.createClientDetails("391.001", "HOTEL EXPRESS CLUB", dFormat.parse("2021-03-25"), dFormat.parse("2021-08-31")));
			...
			hmClientDtl.put("396.001", clsClientDetails.createClientDetails("396.001", "STARLIGHT BAKERY AND CAFE", dFormat.parse("2021-08-04"), dFormat.parse("2021-09-03")));//Released on 4thAug for 1 month(Mumbai)
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
