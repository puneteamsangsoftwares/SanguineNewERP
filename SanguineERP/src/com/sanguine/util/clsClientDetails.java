...
public class clsClientDetails {
	...
	public static void funAddClientCodeAndName() {
		try {
			...
			hmClientDtl.put("117.001", clsClientDetails.createClientDetails("117.001", "THE PREM'S HOTEL", dFormat.parse("2016-08-01"), dFormat.parse("2021-09-01")));//renewed from 1-9-2020 to 1-9-2021 as Sachin sir said//renewed on 01-07-2020 for 15 days till 15-07-2020// HO
			...
			hmClientDtl.put("211.001", clsClientDetails.createClientDetails("211.001", "CHEFS CORNER", dFormat.parse("2017-11-29"), dFormat.parse("2021-05-31")));//renewed on 25-06-2019 for 10 days till 09-07-2019//Renewed On 17-05-2019 for 15 days till 31-05-2019// Renewed on 16-04-2019 for 1 month till 16-05-2019//Renewed on 14-03-2019 for 1 month till 16-04-2019//renewed on 15-02-2019 for 1 month till 15-03-2019 //renwed for on emonth on 01-12-2018 till  //renewed  on 30-11-2018 for one month till 30-12-2018  // renewd
			...
			hmClientDtl.put("240.001", clsClientDetails.createClientDetails("240.001", "THOUSAND OAKS", dFormat.parse("2018-04-12"), dFormat.parse("2021-04-12")));//renewed on 06-11-2020 for 10 days till 17-11-2020//renewed on 22-05-2019 for 1 year//renewed on 01-12-2018 for one month till 01-01-2019//renewed on 20-08-2018 for 1 week till 27-08-2018 //renewed on 13-06-2018 for 1 month// Mr. Sanjeet Lamba", 2417 East Street (G T Road),Camp, Pune 411001. Tel: (020) 2634 3194 / 2634 5598
		   ...
		   //260.001", "PARAG HOTELS AND RESORT PVT LTD" for POS
			...
			hmClientDtl.put("289.001", clsClientDetails.createClientDetails("289.001", "RIVERSIDE BISTRO & BANQUET", dFormat.parse("2020-02-10"), dFormat.parse("2021-02-10")));////Released for 1 month till 03-10-2020
			...
			hmClientDtl.put("319.001", clsClientDetails.createClientDetails("319.001", "LAXMI FOODS", dFormat.parse("2019-06-04"), dFormat.parse("2022-01-19")));//Renewed on 15-01-2021 for 1 year till 19-01-2022 // Released on 07-08-2019 for 1 year till 03-06-2020
			...
			hmClientDtl.put("341.001", clsClientDetails.createClientDetails("341.001", "THE FLOUR WORKS", dFormat.parse("2019-12-01"), dFormat.parse("2021-04-13")));//(Mumbai)//Released on 09-12-2019 for 1 year till 09-12-2020
			...
			hmClientDtl.put("378.001", clsClientDetails.createClientDetails("378.001", "CERATEC", dFormat.parse("2020-12-14"), dFormat.parse("2021-05-09")));
			...
			hmClientDtl.put("389.001", clsClientDetails.createClientDetails("389.001", "HOPWORKS BREWING COMPANY", dFormat.parse("2021-03-23"), dFormat.parse("2021-04-23")));
			hmClientDtl.put("391.001", clsClientDetails.createClientDetails("391.001", "HOTEL EXPRESS CLUB", dFormat.parse("2021-03-25"), dFormat.parse("2021-04-30")));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
