...
public interface clsGlobalFunctionsDao {
	...
	public Map<String, String> funGetUserWisePropertyList(String clientCode, String usercode, String usertype);
	...
	public List funGetExcelCount(String sql, String queryType,int firstLimit,int secondLimit);
}
