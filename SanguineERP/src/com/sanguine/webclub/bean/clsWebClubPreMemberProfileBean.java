...
public class clsWebClubPreMemberProfileBean {
	...
	private String strSpouseCustomerCode;

	private String strSpouseFirstName;

	private String strSpouseMiddleName;

	private String strSpouseLastName;

	private String strSpouseResidentMobileNo;

	private String strSpouseCompanyCode;

	private String strSpouseJobProfileCode;

	private String dteSpouseDateofBirth;

	private String strSpouseProfessionCode;

	private String dteAnniversary;

	private String strSpouseStopCredit;

	private String strSpouseBlocked;

	private String strSpouseCode;

	private String strSpouseResidentEmailID;

	private String strDependentGender;

	private String strDependentMaritalStatus;

	private String dteDependentDateofBirth;

	private String strDependentRelation;

	private String strDependentProfessionCode;

	private String dteDependentMemExpDate;
	...
	public void setStrPrimaryCustomerCode(String strPrimaryCustomerCode) {
		this.strPrimaryCustomerCode = strPrimaryCustomerCode;
	}
	...
	public String getStrSpouseCustomerCode() {
		return strSpouseCustomerCode;
	}

	public void setStrSpouseCustomerCode(String strSpouseCustomerCode) {
		this.strSpouseCustomerCode = strSpouseCustomerCode;
	}

	public String getStrSpouseFirstName() {
		return strSpouseFirstName;
	}

	public void setStrSpouseFirstName(String strSpouseFirstName) {
		this.strSpouseFirstName = strSpouseFirstName;
	}

	public String getStrSpouseMiddleName() {
		return strSpouseMiddleName;
	}

	public void setStrSpouseMiddleName(String strSpouseMiddleName) {
		this.strSpouseMiddleName = strSpouseMiddleName;
	}

	public String getStrSpouseLastName() {
		return strSpouseLastName;
	}

	public void setStrSpouseLastName(String strSpouseLastName) {
		this.strSpouseLastName = strSpouseLastName;
	}

	public String getStrSpouseResidentMobileNo() {
		return strSpouseResidentMobileNo;
	}

	public void setStrSpouseResidentMobileNo(String strSpouseResidentMobileNo) {
		this.strSpouseResidentMobileNo = strSpouseResidentMobileNo;
	}

	public String getStrSpouseCompanyCode() {
		return strSpouseCompanyCode;
	}

	public void setStrSpouseCompanyCode(String strSpouseCompanyCode) {
		this.strSpouseCompanyCode = strSpouseCompanyCode;
	}

	public String getStrSpouseJobProfileCode() {
		return strSpouseJobProfileCode;
	}

	public void setStrSpouseJobProfileCode(String strSpouseJobProfileCode) {
		this.strSpouseJobProfileCode = strSpouseJobProfileCode;
	}

	public String getDteSpouseDateofBirth() {
		return dteSpouseDateofBirth;
	}

	public void setDteSpouseDateofBirth(String dteSpouseDateofBirth) {
		this.dteSpouseDateofBirth = dteSpouseDateofBirth;
	}

	public String getStrSpouseProfessionCode() {
		return strSpouseProfessionCode;
	}

	public void setStrSpouseProfessionCode(String strSpouseProfessionCode) {
		this.strSpouseProfessionCode = strSpouseProfessionCode;
	}
	...
	public String getStrSpouseStopCredit() {
		return strSpouseStopCredit;
	}

	public void setStrSpouseStopCredit(String strSpouseStopCredit) {
		this.strSpouseStopCredit = strSpouseStopCredit;
	}

	public String getStrSpouseBlocked() {
		return strSpouseBlocked;
	}

	public void setStrSpouseBlocked(String strSpouseBlocked) {
		this.strSpouseBlocked = strSpouseBlocked;
	}

	public String getStrSpouseCode() {
		return strSpouseCode;
	}

	public void setStrSpouseCode(String strSpouseCode) {
		this.strSpouseCode = strSpouseCode;
	}

	public String getStrSpouseResidentEmailID() {
		return strSpouseResidentEmailID;
	}

	public void setStrSpouseResidentEmailID(String strSpouseResidentEmailID) {
		this.strSpouseResidentEmailID = strSpouseResidentEmailID;
	}

	public String getStrDependentGender() {
		return strDependentGender;
	}

	public void setStrDependentGender(String strDependentGender) {
		this.strDependentGender = strDependentGender;
	}

	public ArrayList<clsWebClubDependentMasterModel> getListDependentMember() {
		return listDependentMember;
	}

	public void setListDependentMember(ArrayList<clsWebClubDependentMasterModel> listDependentMember) {
		this.listDependentMember = listDependentMember;
	}

	public String getStrDependentMaritalStatus() {
		return strDependentMaritalStatus;
	}

	public void setStrDependentMaritalStatus(String strDependentMaritalStatus) {
		this.strDependentMaritalStatus = strDependentMaritalStatus;
	}
	...
	public String getStrDependentProfessionCode() {
		return strDependentProfessionCode;
	}

	public void setStrDependentProfessionCode(String strDependentProfessionCode) {
		this.strDependentProfessionCode = strDependentProfessionCode;
	}

	public String getDteDependentMemExpDate() {
		return dteDependentMemExpDate;
	}

	public void setDteDependentMemExpDate(String dteDependentMemExpDate) {
		this.dteDependentMemExpDate = dteDependentMemExpDate;
	}

	public String getStrDependentBlock() {
		return strDependentBlock;
	}

	public void setStrDependentBlock(String strDependentBlock) {
		this.strDependentBlock = strDependentBlock;
	}
