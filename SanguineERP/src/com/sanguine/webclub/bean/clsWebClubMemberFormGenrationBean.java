...
public class clsWebClubMemberFormGenrationBean {
	...
	public void setStrProspectName(String strProspectName) {
		this.strProspectName = strProspectName;
	}

	public String getDteGenration() {
		return dteGenration;
	}

	public void setDteGenration(String dteGenration) {
		this.dteGenration = dteGenration;
	}

	public String getDteFormIssue() {
		return dteFormIssue;
	}
